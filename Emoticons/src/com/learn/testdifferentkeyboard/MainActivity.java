...
public class MainActivity extends FragmentActivity implements KeyClickListener {
	...
	private static final int NO_OF_EMOTICONS = 53;
	...
	private boolean isKeyBoardVisible,choice;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mListen=(Button) findViewById(R.id.button2);
		mSpeak=(Button) findViewById(R.id.button1);
